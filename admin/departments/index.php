...
<div class="card card-outline">
	<div class="card-header bg-primary text-white">
		<h3 class="card-title"><i class="fas fa-th-list me-2"></i><b>List of Department(s)</b></h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-info"><span class="fas fa-plus"></span>  Add New Department</a>
		</div>
	</div>
	<div class="card-body">
