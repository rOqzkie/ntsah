...
<div class="card card-outline">
	<div class="card-header bg-primary text-white">
		<h3 class="card-title"><i class="fas fa-scroll me-2"></i><b>List of Program(s)</b></h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-info"><span class="fas fa-plus"></span>  Add New Program</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Program Details","program/manage_program.php")
		})
        $('.edit_data').click(function(){
			uni_modal("Program Details","program/manage_program.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Program permanently?","delete_program",[$(this).attr('data-id')])
		})
		$('.view_data').click(function(){
			uni_modal("Program Details","program/view_program.php?id="+$(this).attr('data-id'))
		})
