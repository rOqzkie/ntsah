...
<div class="h-100 d-flex  align-items-center w-100" id="login">
    ...
    <div class="col-5 h-100 bg-gradient bg-maroon">
        <div class="w-100 d-flex justify-content-center align-items-center h-100 text-navy">
            <div class="card card-outline card-primary rounded-0 shadow col-lg-10 col-md-10 col-sm-5 col-xs-12">
                <div class="card-header">
                    <h5 class="card-title text-center text-dark"><b>Registration Form</b></h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                                <div class="form-group text-right">
                                    <button class="btn btn-default bg-info btn-flat"><i class="fas fa-registered"></i> Register</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
  ...
  function validateEmail(input) {
            ...
            if (pattern.test(email)) {
                ...
                alert("Invalid email address. Please use @nemsu.edu.ph email.");
