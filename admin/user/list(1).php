...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title"><b>List of System Users</b></h3>
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Add Department Chair</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td ><p class="m-0 truncate-1"><?php echo $row['department_id'] ?></p></td>
