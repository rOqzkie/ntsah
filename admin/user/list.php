...
<div class="card card-outline">
	<div class="card-header bg-primary text-white">
		<h3 class="card-title"><i class="fas fa-users-cog me-2"></i><b>List of Department Chair(s)</b></h3>
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-info"><span class="fas fa-plus"></span>  Add Department Chair</a>
		</div>
	</div>
	<div class="card-body">
			...
			<table class="table table-hover table-striped">
				...
				<tbody>
					<?php 
						...
						$department = $conn->query("SELECT * FROM department_list where id in (SELECT department_id from `users`)");
					...
					?>
						<tr>
							...
							<td ><p class="m-0"><?php echo ($row['type'] == 1 )? "Adminstrator" : "Department Chair" ?></p></td>
							<td align="center">
...
<script>
	$(document).ready(function(){
		...
		$('.table').dataTable({
            language: {
                searchPlaceholder: "Search dept. chair...",
                search: "_INPUT_" // Keeps only the input box without label
            }
        });
