...
<div class="h-100 d-flex align-items-center w-100" id="login">
    <!--
    <div class="col-lg-6 col-md-12 registration-container d-flex align-items-center justify-content-end shadow">
    ...
    -->
    <!--<div class="col-lg-6 col-md-12 bg-gradient bg-white registration-form-container">-->
        <div class="w-100 d-flex justify-content-center align-items-center h-100 text-navy">
            <div class="card card-outline card-primary rounded-0 shadow col-lg-10 col-md-10 col-sm-12 col-xs-12">
                <div class="card-header">
                    <h5 class="card-title text-center text-dark"><b>Adviser Registration Form</b></h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <span class="text-navy"><medium><b>Employee ID No.</b></medium></span>
                                    <input type="text" name="adviser_id" id="adviser_id" autofocus placeholder="Employee ID No." class="form-control form-control-border" required>
                                </div>
                                        ...
                                        <div class="form-group col-auto d-flex">
                                            <div class="custom-control custom-radio me-5">
                                                <input class="custom-control-input" type="radio" id="genderMale" name="gender" value="Male" required checked>
                                                    <label for="genderMale" class="custom-control-label">Male</label>&emsp;
                                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <span class="text-navy"><medium><b>Academic Rank</b></medium></span>
                                        <select name="position_id" id="position_id" class="form-control form-control-border select2" data-placeholder="Select Academic Rank" required>
                                            <option value=""></option>
                                                <?php 
                                                    $position = $conn->query("SELECT * FROM `position_list` where status = 1 order by `name` asc");
                            ...
                            <div class="col-12 form-group mt-3">
                                ...
                                <label for="nda-read">
                                    ...
                                    <a href="nda-adviser.php" target="_blank">Non-Disclosure Agreement</a>
                                </label>
                            </div>
                            <br>
                    ...
                    <div class="text-center mt-3">
                        <b>Already have an account?</b><a href="login-adviser.php" class="btn btn-info btn-block">Log In</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        $.ajax({
            ...
            success:function(resp){
                if(resp.status == 'success'){
                    location.href= "./login-adviser.php"
                }else if(!!resp.msg){
                    el.text(resp.msg)
                    el.addClass("alert-danger")
                    _this.prepend(el)
