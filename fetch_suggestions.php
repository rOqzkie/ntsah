...
if (empty($suggestions)) { // If DB is empty, get full AI-generated suggestions
    $llama_api_key = env('LLAMA_API_KEY');
    $llama_url = "https://api.together.ai/models/meta-llama/Llama-3.3-70B-Instruct-Turbo-Fre"; 
    ...
    if (isset($llama_response['choices'][0]['text'])) {
        ...
        $suggestions = array_filter($ai_suggestions);
    }
}
