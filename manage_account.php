            ...
            <div class="container-fluid">
                <form action="" id="update-form">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="studid" class="control-label text-navy">Student ID No.</label>
                                <input type="text" name="studid" id="studid" autofocus placeholder="Student ID No." class="form-control form-control-border" value="<?= isset($studid) ?$studid : "" ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <label for="" class="control-label text-dark">Gender</label>
                        </div>
                        <div class="form-group col-auto">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="oldpassword" class="text-dark">Please Enter your Current Password</label>
